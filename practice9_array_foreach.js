let names = ["Clark", "Bruce", "Barry", "Diane", "John"];
...
console.log(charCountArray); // [ 5, 5, 5, 5, 4, 4 ]

let upperNames = names.map( each => each.toUpperCase() );
console.log(upperNames);// [ 'CLARK', 'BRUCE', 'BARRY', 'DIANE', 'JOHN', 'SNOW' ]
